...
(function (root, factory) {
    ...
    BootstrapDialogModal.METHODS_TO_OVERRIDE['v5.1'] = $.extend({}, BootstrapDialogModal.METHODS_TO_OVERRIDE['v4.1']);
    ...
    BootstrapDialog.Z_INDEX_BACKDROP = 1140;
    BootstrapDialog.Z_INDEX_MODAL = 1150;
    ...
    // ✅ FIX CHÍNH CHO BOOTSTRAP 5
    BootstrapDialog.METHODS_TO_OVERRIDE['v5.1'] = {
        // Lấy backdrop element cho Bootstrap 5
        getModalBackdrop: function ($modal) {
            ...
            if (modalInstance && modalInstance._backdrop && modalInstance._backdrop._element) {
                return $(modalInstance._backdrop._element);
            }
            // Fallback: tìm backdrop bằng class
            return $('.modal-backdrop').last();
        },

        // Update z-index cho cả modal và backdrop
        updateZIndex: function () {
            if (this.isOpened()) {
                var zIndexBackdrop = BootstrapDialog.Z_INDEX_BACKDROP;
                var zIndexModal = BootstrapDialog.Z_INDEX_MODAL;
                ...
                // Tăng z-index cho mỗi dialog
                var modalZIndex = zIndexModal + (dialogCount - 1) * 20;
                var backdropZIndex = zIndexBackdrop + (dialogCount - 1) * 20;
        ...
        // Override open method để gọi updateZIndex
        open: function () {
            !this.isRealized() && this.realize();
            ...
            // Đợi modal hiển thị xong rồi mới update z-index
            var that = this;
            setTimeout(function () {
                that.updateZIndex();
            }, 50);
        ...
        // Override close method cho Bootstrap 5
        close: function () {
            !this.isRealized() && this.realize();
        ...
        // Custom close button cho Bootstrap 5
    ...
    BootstrapDialog.prototype = {
        ...
        createModal: function () {
            var $modal = $('<div class="modal" role="dialog" aria-hidden="true" tabindex="-1"></div>');
        ...
        createButton: function (button) {
            ...
            $button.on('click', { dialog: this, $button: $button, button: button }, function (event) {
                ...
                if (typeof button.action === 'function') {
                    ...
                    // Nếu action return true hoặc undefined, tự động đóng dialog
                    if (result !== false) {
                        dialog.close();
                    }
                    return result;
        ...
        makeModalDraggable: function () {
            if (this.options.draggable) {
                ...
                // Thêm CSS để tối ưu performance
                $modalDialog.css({
                ...
                // Thêm cursor style
                $header.addClass(dialog.getNamespace('draggable')).css({
                    'cursor': 'move',
                    'user-select': 'none',
                ...
                // Sử dụng transform thay vì offset để tăng performance
                ...
                function dragEnd(e) {
                    if (isDragging) {
                        ...
                        // Xóa class khi thả
                        $modalDialog.removeClass('dragging');
                ...
                function drag(e) {
                    if (isDragging) {
                        ...
                        // Sử dụng transform thay vì offset() để loại bỏ delay
